...
public class FileServerController {
	...
	public ResponseEntity<Object> download(@PathVariable("folder") String folder, @PathVariable("file") String file) {
		logger.debug("download file info folder : {}, file : {}", folder, file);
		String fileP = uploadPath + File.separator + folder + File.separator + file;
