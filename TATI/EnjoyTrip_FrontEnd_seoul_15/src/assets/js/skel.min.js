    ...
    var t = {
                ...
                window.matchMedia
                    ...
                    ? (t.matchesMedia = function (t) {
                          ...
                          (e.type = "text/css"),
                              ...
                              (i =
                                  ("getComputedStyle" in window && window.getComputedStyle(e, null)) || e.currentStyle);
        ...
        initVars: function () {
            ...
            (e = "other"),
                ...
                t.iterate(i, function (t, i) {
                    return a.match(i[1])
                        ? ((e = i[0]), (n = parseFloat(i[2] ? i[2](RegExp.$1) : RegExp.$1)), !1)
                        : void 0;
                }),
                (t.vars.os = e),
                (t.vars.osVersion = n),
                ...
                (t.vars.mobile =
                    "wp" == t.vars.os || "android" == t.vars.os || "ios" == t.vars.os || "bb" == t.vars.os);
        },
    };
    return t.init(), t;
})();
